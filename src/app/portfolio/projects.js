const projects= [
    {
      ...
      },
      {
        ...
        title: "Medguardian",
        desc: "Medguardian - A full-stack smart medication reminder and health tracker app. It ensures real-time medication tracking with one-time daily marking, time-restricted entries for accuracy, and automated email reminders for missed doses. Integrated Chart.js for real-time health visualization and secure authentication for a seamless user experience. 🚀",
